...
class InitializationWelcomeViewModel @Inject constructor(
    private val sessionRepository: SessionRepository,
    private val userRepository: UserRepository
) : BaseViewModel<InitializationWelcomeNavigator>() {
    ...
    val userName: LiveData<String> =
        Transformations.map(sessionRepository.getInitializationDataLiveData()) { initialization ->
            initialization?.name
        }
    ...
    fun concludeClicked(): LiveData<Resource<Nothing?, Nothing?>>? {
